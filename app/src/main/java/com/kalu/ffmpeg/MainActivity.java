...
import lib.kalu.ffmpegcmd.FFmpegUtil;
...
//                Log.e("ffmpeg_main", "getFilters = " + fIltersJNI);
        ...
        // button_process_mpeg
        findViewById(R.id.button_process_mpeg).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String absolutePath = getApplicationContext().getCacheDir().getAbsolutePath();
                String fromPath = absolutePath + "/285367220.mpeg";
                String toPath = absolutePath + "/285367220.mp3";
                String s = FFmpegUtil.clipAudio(fromPath, toPath);
                Log.e("FFM", "cmd => " + s);
            }
        });

        // button_process_mpeg
        findViewById(R.id.button_process_mpeg_2).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String absolutePath = getApplicationContext().getCacheDir().getAbsolutePath();
                String toPath = absolutePath + "/285367220.mp3";
...
//                String absolutePath = "/storage/emulated/0";
    ...
    private void init() {
        ...
        String absolutePath = getApplicationContext().getCacheDir().getAbsolutePath();
//        String absolutePath = "/storage/emulated/0";
        List<String> list = Arrays.asList("285367220.mpeg", "a1.mp3", "a2.mp3", "a3.mp3", "a4.mp3", "a5.mp3", "a6.pcm", "a7.pcm", "xiri.pcm", "a8.mp3", "a9.mp3", "v25.mp4", "v35.mp4");
