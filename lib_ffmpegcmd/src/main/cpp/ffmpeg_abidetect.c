...
JNINativeMethod abiDetectMethods[] = {
  {"getNativeAbi", "()Ljava/lang/String;", (void*) Java_lib_kalu_ffmpegcmd_entity_AbiDetect_getNativeAbi},
  {"getNativeCpuAbi", "()Ljava/lang/String;", (void*) Java_lib_kalu_ffmpegcmd_entity_AbiDetect_getNativeCpuAbi},
  {"isNativeLTSBuild", "()Z", (void*) Java_lib_kalu_ffmpegcmd_entity_AbiDetect_isNativeLTSBuild},
  {"getNativeBuildConf", "()Ljava/lang/String;", (void*) Java_lib_kalu_ffmpegcmd_entity_AbiDetect_getNativeBuildConf}
};
 ...
 */
JNIEXPORT jstring JNICALL Java_lib_kalu_ffmpegcmd_entity_AbiDetect_getNativeAbi(JNIEnv *env, jclass object) {
 ...
 */
JNIEXPORT jstring JNICALL Java_lib_kalu_ffmpegcmd_entity_AbiDetect_getNativeCpuAbi(JNIEnv *env, jclass object) {
 ...
 * @return yes or no
 */
JNIEXPORT jboolean JNICALL Java_lib_kalu_ffmpegcmd_entity_AbiDetect_isNativeLTSBuild(JNIEnv *env, jclass object) {
 ...
 */
JNIEXPORT jstring JNICALL Java_lib_kalu_ffmpegcmd_entity_AbiDetect_getNativeBuildConf(JNIEnv *env, jclass object) {
