...
/*
 * Class:     com_devyk_ffmpeglib_entity_AbiDetect
 * Method:    getNativeAbi
 * Signature: ()Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_lib_kalu_ffmpegcmd_entity_AbiDetect_getNativeAbi(JNIEnv *, jclass);
 ...
 * Signature: ()Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_lib_kalu_ffmpegcmd_entity_AbiDetect_getNativeCpuAbi(JNIEnv *, jclass);
 ...
 * Signature: ()Z
 */
JNIEXPORT jboolean JNICALL Java_lib_kalu_ffmpegcmd_entity_AbiDetect_isNativeLTSBuild(JNIEnv *, jclass);
 ...
 * Signature: ()Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_lib_kalu_ffmpegcmd_entity_AbiDetect_getNativeBuildConf(JNIEnv *, jclass);
