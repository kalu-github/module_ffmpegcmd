...
#define FFMPEG_CONFIGURATION "--pkg-config='pkg-config --static' --logfile=log_build_x86.txt --target-os=android --prefix=/home/kalu/download/ffmpeg/ff4.4.4-lame-x264/build/ffmpeg/android/x86 --enable-small --enable-cross-compile --extra-libs=-lgcc --arch=x86 --cc=/home/kalu/download/android-ndk/r14b/toolchains/x86-4.9/prebuilt/linux-x86_64/bin/i686-linux-android-gcc --cross-prefix=/home/kalu/download/android-ndk/r14b/toolchains/x86-4.9/prebuilt/linux-x86_64/bin/i686-linux-android- --nm=/home/kalu/download/android-ndk/r14b/toolchains/x86-4.9/prebuilt/linux-x86_64/bin/i686-linux-android-nm --extra-cflags=-I/home/kalu/download/ffmpeg/ff4.4.4-lame-x264/build/x264/android/x86/include --extra-ldflags=-L/home/kalu/download/ffmpeg/ff4.4.4-lame-x264/build/x264/android/x86/lib --extra-cflags=-I/home/kalu/download/ffmpeg/ff4.4.4-lame-x264/build/../mp3lame/include --extra-ldflags=-L/home/kalu/download/ffmpeg/ff4.4.4-lame-x264/build/mp3lame/local/x86 --sysroot=/home/kalu/download/android-ndk/r14b/platforms/android-18/arch-x86/ --host-cflags=-fPIC --host-cppflags=-fPIC --host-ldflags=-fPIC --extra-cflags=-fPIC --extra-cxxflags=-fPIC --extra-ldflags='-lx264 -Wl,-rpath-link=/home/kalu/download/android-ndk/r14b/platforms/android-18/arch-x86//usr/lib -L/home/kalu/download/android-ndk/r14b/platforms/android-18/arch-x86//usr/lib -fPIC -nostdlib -lc -lm -ldl -llog' --enable-static --disable-symver --disable-network --disable-programs --disable-ffmpeg --disable-ffplay --disable-ffprobe --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-avcodec --enable-avfilter --enable-avresample --enable-postproc --enable-swscale --enable-avdevice --enable-avformat --enable-avutil --enable-swresample --enable-decoders --enable-encoders --enable-encoder=libx264 --enable-encoder=libmp3lame --enable-hwaccels --enable-parsers --enable-demuxers --enable-muxers --enable-protocols --enable-filters --enable-bsfs --enable-indevs --enable-outdevs --enable-libx264 --enable-libmp3lame --enable-optimizations --enable-zlib --disable-debug --enable-small --enable-pic --disable-x86asm --disable-asm --disable-yasm --disable-stripping --disable-jni --disable-mediacodec --enable-gpl --enable-nonfree --enable-version3"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2023
#define FFMPEG_DATADIR "/home/kalu/download/ffmpeg/ff4.4.4-lame-x264/build/ffmpeg/android/x86/share/ffmpeg"
#define AVCONV_DATADIR "/home/kalu/download/ffmpeg/ff4.4.4-lame-x264/build/ffmpeg/android/x86/share/ffmpeg"
