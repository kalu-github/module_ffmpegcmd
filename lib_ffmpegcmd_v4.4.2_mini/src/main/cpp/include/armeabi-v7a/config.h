...
#define FFMPEG_CONFIGURATION "--pkg-config='pkg-config --static' --target-os=android --prefix=/home/kalu/Downloads/ffmpeg-android/build/ffmpeg/android/armeabi-v7a --enable-small --enable-cross-compile --extra-libs=-lgcc --arch=arm --cc=/Android/Sdk/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-gcc --cross-prefix=/Android/Sdk/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi- --nm=/Android/Sdk/ndk/android-ndk-r14b/toolchains/arm-linux-androideabi-4.9/prebuilt/linux-x86_64/bin/arm-linux-androideabi-nm --extra-cflags=-I/home/kalu/Downloads/ffmpeg-android/build/x264/android/arm/include --extra-ldflags=-L/home/kalu/Downloads/ffmpeg-android/build/x264/android/arm/lib --extra-cflags=-I/home/kalu/Downloads/ffmpeg-android/build/../mp3lame/include --extra-ldflags=-L/home/kalu/Downloads/ffmpeg-android/build/mp3lame/local/armeabi-v7a --sysroot=/Android/Sdk/ndk/android-ndk-r14b/platforms/android-16/arch-arm --extra-cflags='-DANDROID -fPIC -ffunction-sections -funwind-tables -fstack-protector -march=armv7-a -mfloat-abi=softfp -mfpu=vfpv3-d16 -fomit-frame-pointer -fstrict-aliasing -funswitch-loops -finline-limit=300' --extra-ldflags='-lx264 -Wl,-rpath-link=/Android/Sdk/ndk/android-ndk-r14b/platforms/android-16/arch-arm/usr/lib -L/Android/Sdk/ndk/android-ndk-r14b/platforms/android-16/arch-arm/usr/lib -nostdlib -lc -lm -ldl -llog' --enable-static --disable-symver --disable-network --disable-debug --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --disable-ffplay --disable-ffmpeg --disable-ffprobe --enable-avdevice --enable-avcodec --enable-avformat --enable-swresample --enable-swscale --enable-postproc --enable-avfilter --enable-avresample --disable-bsfs --disable-devices --disable-indevs --enable-indev=lavfi --disable-outdevs --disable-protocols --enable-protocol=file --enable-protocol=concat --disable-parsers --disable-muxers --enable-muxer=pcm_u8 --enable-muxer=pcm_s16le --enable-muxer=pcm_s16be --enable-muxer=mp3 --enable-muxer=mov --enable-muxer=mp4 --enable-muxer=image2 --enable-muxer=ipod --enable-muxer=gif --disable-demuxers --enable-demuxer=pcm_u8 --enable-demuxer=pcm_s16le --enable-demuxer=pcm_s16be --enable-demuxer=mp3 --enable-demuxer=mov --enable-demuxer=image2 --enable-demuxer=gif --enable-demuxer=wav --enable-demuxer=asf --enable-demuxer=flv --enable-demuxer=avi --enable-demuxer=webm_dash_manifest --enable-demuxer=matroska --enable-demuxer=mpegts --disable-decoders --enable-decoder=pcm_u8 --enable-decoder=pcm_s16le --enable-decoder=pcm_s16be --enable-decoder=aac --enable-decoder=png --enable-decoder=h264 --enable-decoder=mp3 --enable-decoder=mjpeg --enable-decoder=mpeg4 --enable-decoder=gif --enable-decoder=hevc --enable-decoder=msmpeg4v1 --enable-decoder=msmpeg4v2 --enable-decoder=msmpeg4v3 --enable-decoder=wmav1 --enable-decoder=wmav2 --enable-decoder=flv --enable-decoder=adpcm_swf --enable-decoder=ac3 --enable-decoder=vp8 --enable-decoder=vorbis --enable-decoder=mpeg2video --enable-decoder=mp2 --enable-decoder=indeo4 --enable-decoder=amrnb --disable-encoders --enable-encoder=pcm_u8 --enable-encoder=pcm_s16le --enable-encoder=pcm_s16be --enable-encoder=aac --enable-encoder=png --enable-encoder=libmp3lame --enable-encoder=mjpeg --enable-encoder=gif --enable-encoder=libx264 --enable-swscale --disable-filters --enable-filter=crop --enable-filter=scale --enable-filter=afade --enable-filter=atempo --enable-filter=copy --enable-filter=aformat --enable-filter=overlay --enable-filter=vflip --enable-filter=hflip --enable-filter=transpose --enable-filter=volume --enable-filter=rotate --enable-filter=apad --enable-filter=amerge --enable-filter=aresample --enable-filter=setpts --enable-filter=fps --enable-filter=palettegen --enable-filter=paletteuse --enable-filter=trim --enable-filter=null --enable-filter=overlay --enable-filter=format --enable-filter=atrim --enable-filter=split --enable-filter=amix --enable-filter=anull --enable-filter=adelay --enable-filter=anullsrc --enable-filter=adelay --enable-filter=afftdn --enable-filter=pan --enable-gpl --enable-libx264 --enable-zlib --enable-libmp3lame --enable-jni --enable-nonfree --enable-mediacodec --enable-asm --enable-version3 --disable-doc --enable-neon"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2021
#define FFMPEG_DATADIR "/home/kalu/Downloads/ffmpeg-android/build/ffmpeg/android/armeabi-v7a/share/ffmpeg"
#define AVCONV_DATADIR "/home/kalu/Downloads/ffmpeg-android/build/ffmpeg/android/armeabi-v7a/share/ffmpeg"
